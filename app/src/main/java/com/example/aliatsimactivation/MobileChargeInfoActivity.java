...
public class MobileChargeInfoActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState)  {
        ...
        MobileChargePagerAdapter pagerAdapter  = new MobileChargePagerAdapter(getSupportFragmentManager(), tabLayout.getTabCount());
